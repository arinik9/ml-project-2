...
\section{Song recommendation}
  ...
  However, we did achieve a small improvement by using a measure of ``likeability'' of artists.
  ...
  Artist-based: $1.39$. See ``content based'' approach to cold start (cite Microsoft Research paper).
