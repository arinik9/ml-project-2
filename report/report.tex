  ...
  Using a reduced number of features also helps avoiding overfitting, as we are, to some extend, using only the signal (residing in the principal components).
   ...
   \begin{figure}[ht]
       \center
    	...
    	\hfill
	\subfigure[Associated boxplots informing confirms $100$ principal components as good option even though it is not the most robust option.]{
      		\includegraphics[width=2.5in]{figures/detection/pcaselection-boxplots3.pdf}
